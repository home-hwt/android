...
import com.test.process.model.AnnotatedClass;
import com.test.process.model.BindViewField;
import com.test.process.model.OnClickMethod;
...
public class ViewFinderProcesser extends AbstractProcessor {
    ...
    private AnnotatedClass getAnnotatedClass(Element element) {
        ...
        info("fullClassName" + fullClassName,fullClassName+"1");
